...
//		s.append("Date: " + HttpResponseUtils.getServerTime()+"\n");
//		s.append("Server: WEBAPPSERVER\n");
//		s.append("Content-Type: text/html; charset=utf-8\n");
//		s.append("Content-Length: 5\n");
//		s.append("Set-Cookie: name=xyz; expires=Friday, 04-Feb-18 22:03:38 GMT; path=/; domain=localhost\n");
//		s.append("\n");
//		s.append("abcde");
//		out.write(s.toString());
		...
		counterCookie.setPath("/SetCookie");
